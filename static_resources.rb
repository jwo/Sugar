...
file "public/javascripts/jquery.watermark.js", open("#{@@base_path}resources/jquery.watermark.js", "rb"){|file| file.read}

run 'rm public/stylesheets/chaione.css'
file "public/stylesheets/chaione.css", open("#{@@base_path}resources/chaione.css", "rb"){|file| file.read}
